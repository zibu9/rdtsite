...
<body> 
  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-primary"> <a class="navbar-brand" href="index.php">  <div class="container">
   ...
   <?php if (isset($_SESSION['flash'])): ?>
                ...
                {
                     if ((isset($_GET['id_us']) AND isset($_GET['prenom'])) || isset($_SESSION['admin']))
                     {
                          $prenom = htmlspecialchars($_GET['prenom']);
                           $id_us = htmlspecialchars($_GET['id_us']);
                                          ...
                                          <div class="col-md-12 col-lg-12 col-sm-12">
                                            <div class="contact-form">
                                             ...
                                             <form action="reponse.php" method="POST">
                                                <textarea class="input" name="message" placeholder="Entrer votre Message" style="height: 100px;"></textarea>
