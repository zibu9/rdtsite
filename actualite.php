            ...
            <ul class="navbar-nav ml-auto">
             <li class="nav-item"> <a class="nav-link js-scroll-trigger" href="index.php"><i class="fas fa-home"></i>Accueil</a>
              ...
              <u> ACTUALITES</u>
                    ...
                    <section class="row">
                    <?php
                        $message = $bdd->query ('SELECT id, badge, titre, photo, details, DATE_FORMAT(ladate, \'%d/%m/%Y à %H:%i\')AS ladate  FROM actualite ORDER BY id DESC LIMIT 0,9');
                                         ...
                                         <div class="col-lg-4 col-sm-12 col-md-6 col-xs-1 mt-2">
                                              ...
                                              <div class="card">
                                                ...
                                                <div class="view overlay">
                                                  <!-- <a href="http://localhost/rdtretouche/details.php?id=<?=$donnees->id; ?>&titre=<?=$donnees->titre; ?>"> --><a href="https://zibu.000webhostapp.com/rdt/details.php?id=<?=$donnees->id; ?>&titre=<?=$donnees->titre; ?>">
                                                ...
                                                <div class="card-body">
                                                 <!-- Title -->
                                                  ...
                                                  <!-- <a href="http://localhost/rdtretouche/details.php?id=<?=$donnees->id; ?>&titre=<?=$donnees->titre; ?>" class="black-text d-flex justify-content-end"> -->
                                                    ...
                                                    <h6>Lire plus <i class="fas fa-angle-double-right"></i></h6>
                                                  </a>
                                                </div>
                                              </div>      
                                          <br>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-end">
                                          <li class="page-item disabled">
                                            <a class="page-link" href="#" tabindex="-1" aria-disabled="true">Page precedente</a>
                                          </li>
                                     <?php
                        $message = $bdd->query ('SELECT id, badge, titre, photo, details, DATE_FORMAT(ladate, \'%d/%m/%Y à %H:%i\')AS ladate  FROM actualite ORDER BY id DESC LIMIT 9,18');
                          $donnees = $message->fetch();
                          if($donnees)
                                {  

                                  ?>
                                          <li class="page-item">
                                            <a class="page-link" href="actualite2.php">Page suivante</a>
                                          </li>
                                        <?php } 
                                        else{ ?>
                                          <li class="page-item disabled">
                                            <a class="page-link" tabindex="-1" aria-disabled="true" href="actualite2.php">Page suivante</a>
                                          </li>
                                          <?php 
                                        }
                                        ?>
