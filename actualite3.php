                          ...
                          <?php } ?>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination justify-content-end">
                                          <li class="page-item">
                                            <a class="page-link" href="actualite2.php">Page precedente</a>
                                          </li>
                                     <?php
                        $message = $bdd->query ('SELECT id, badge, titre, photo, details, DATE_FORMAT(ladate, \'%d/%m/%Y à %H:%i\')AS ladate  FROM actualite ORDER BY id DESC LIMIT 27,36');
                          ...
                          if($donnees)
                                {  
                                  ...
                                  ?>
                                          <li class="page-item">
                                            <a class="page-link" href="actualite4.php">Page suivante</a>
                                          </li>
                                        <?php } 
                                        else{ ?>
                                          <li class="page-item disabled">
                                            <a class="page-link" tabindex="-1" aria-disabled="true" href="actualite4.php">Page suivante</a>
                                          </li>
                                          <?php 
                                        }
                                        ?>
